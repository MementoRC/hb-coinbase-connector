...
from coinbase_connector.tools.fixture_recorder import capture_rest, main, sanitize
...
async def test_main_creates_rest_dir_and_captures_endpoints(tmp_path: Path) -> None:
    ...
    with (
        patch("coinbase_connector.tools.fixture_recorder.CoinbaseGateway") as mock_gw_cls,
        patch("coinbase_connector.tools.fixture_recorder.CoinbaseConfig") as mock_cfg_cls,
        patch(
            "coinbase_connector.tools.fixture_recorder.capture_rest",
